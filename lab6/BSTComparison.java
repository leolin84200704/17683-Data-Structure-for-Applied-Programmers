...
public class BSTComparison {
     ...
     * @return  theBST BST data structure
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Search on BST search: " + timer1.elapsedTime() + " millisec");

        Stopwatch timer2 = new Stopwatch();
        binarySearch(array, VALUE_TO_SEARCH);
        System.out.println(" Search (binary search) on ordered array: " + timer2.elapsedTime() + " millisec");

        Stopwatch timer3 = new Stopwatch();
        llist.contains(VALUE_TO_SEARCH);
        System.out.println(
                " Search, or contains call, on linkedlist: " + timer3.elapsedTime() + " millisec");

        System.out.println(" *****************************************************");
        Stopwatch timer4 = new Stopwatch();
        theBST.delete(0);
        System.out.println(" Delete on BST: " + timer4.elapsedTime() + " millisec");

        Stopwatch timer5 = new Stopwatch();
        delete(array, 0);
        System.out.println(" Delete on ordered array: " + timer5.elapsedTime() + " millisec");

        Integer llvalue = Integer.valueOf(VALUE_TO_SEARCH);
        Stopwatch timer6 = new Stopwatch();
        llist.remove(llvalue);
        System.out.println(" Delete on linked list: " + timer6.elapsedTime() + " millisec");

        System.out.println(" *****************************************************");
        Stopwatch timer7 = new Stopwatch();
        theBST.insert(0);
        System.out.println(" Insert on BST: " + timer7.elapsedTime() + " millisec");

        Stopwatch timer8 = new Stopwatch();
        insert(array, 0);
        System.out.println(" Insert on ordered array: " + timer8.elapsedTime() + " millisec");

        Stopwatch timer9 = new Stopwatch();
        llist.add(llvalue);
        System.out.println(" Insert on linked list: " + timer9.elapsedTime() + " millisec");
    }
